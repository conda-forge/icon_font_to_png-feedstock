About icon_font_to_png-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/icon_font_to_png-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11965&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/icon_font_to_png-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `icon_font_to_png` can be installed with `conda`:
...
```
mamba install icon_font_to_png
```

It is possible to list all of the versions of `icon_font_to_png` available on your platform with `conda`:
...
```
mamba search icon_font_to_png --channel conda-forge
```
...
mamba repoquery search icon_font_to_png --channel conda-forge

# List packages depending on `icon_font_to_png`:
mamba repoquery whoneeds icon_font_to_png --channel conda-forge

# List dependencies of `icon_font_to_png`:
mamba repoquery depends icon_font_to_png --channel conda-forge
```
